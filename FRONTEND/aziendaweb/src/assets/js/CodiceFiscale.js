...
CodiceFiscale = function (generality) {
...
CodiceFiscale.prototype.communeCode = function () {
    var city = this.generality("city"), stringToMatch = /^[A-Z]\d\d\d$/i;
    if (city.match(stringToMatch)) {
        return city;
    }
...
CodiceFiscale.prototype._commune = function () {
    var city = this.generality("city"), code = [], commune = [], communeCodeToReturn = [], stringToReplace = /([\\\.\+\*\?\[\^\]\$\(\)\{\}\=\!<\>\|\:])/g, quoted = "", re = "", regex = "";
    quoted = city.replace(stringToReplace, "\\$1");
...
CodiceFiscale.prototype._options = function (generality) {
    var options = {
        ...
        city: generality.city || generality[6]
    };
    return options;
};
